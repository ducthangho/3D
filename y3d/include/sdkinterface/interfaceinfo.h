...
// --------------------list functions of core interface ISOLATESELECTION--------------------------
// Number function of ISOLATESELECTION core interface is 5
#define IISOLATESELECTION_NUMFUCNTIONS 5
// function ID of function ENTERISOLATESELECTIONMODE of core interface ISOLATESELECTION is 0
#define ENTERISOLATESELECTIONMODE_IISOLATESELECTION 0
  // Result Type of function ENTERISOLATESELECTIONMODE of core interface ISOLATESELECTION is ParamType::TYPE_BOOL
  #define ENTERISOLATESELECTIONMODE_IISOLATESELECTION_RESULTTYPE ParamType::TYPE_BOOL
  // number parameter of fucntion ENTERISOLATESELECTIONMODE of core interface ISOLATESELECTION is 0
  #define ENTERISOLATESELECTIONMODE_IISOLATESELECTION_NUMPARAMS 0
// function ID of function EXITISOLATESELECTIONMODE of core interface ISOLATESELECTION is 1
#define EXITISOLATESELECTIONMODE_IISOLATESELECTION 1
  // Result Type of function EXITISOLATESELECTIONMODE of core interface ISOLATESELECTION is ParamType::TYPE_BOOL
  #define EXITISOLATESELECTIONMODE_IISOLATESELECTION_RESULTTYPE ParamType::TYPE_BOOL
  // number parameter of fucntion EXITISOLATESELECTIONMODE of core interface ISOLATESELECTION is 0
  #define EXITISOLATESELECTIONMODE_IISOLATESELECTION_NUMPARAMS 0
// function ID of function ISOLATESELECTIONMODEACTIVE of core interface ISOLATESELECTION is 2
#define ISOLATESELECTIONMODEACTIVE_IISOLATESELECTION 2
  // Result Type of function ISOLATESELECTIONMODEACTIVE of core interface ISOLATESELECTION is ParamType::TYPE_BOOL
  #define ISOLATESELECTIONMODEACTIVE_IISOLATESELECTION_RESULTTYPE ParamType::TYPE_BOOL
  // number parameter of fucntion ISOLATESELECTIONMODEACTIVE of core interface ISOLATESELECTION is 0
  #define ISOLATESELECTIONMODEACTIVE_IISOLATESELECTION_NUMPARAMS 0
// function ID of function ISNODEISOLATED of core interface ISOLATESELECTION is 3
#define ISNODEISOLATED_IISOLATESELECTION 3
  // Result Type of function ISNODEISOLATED of core interface ISOLATESELECTION is ParamType::TYPE_BOOL
  #define ISNODEISOLATED_IISOLATESELECTION_RESULTTYPE ParamType::TYPE_BOOL
  // number parameter of fucntion ISNODEISOLATED of core interface ISOLATESELECTION is 1
  #define ISNODEISOLATED_IISOLATESELECTION_NUMPARAMS 1
  #define NODE_ISNODEISOLATED_IISOLATESELECTION_PARAM1_TYPE ParamType2::TYPE_INODE
  // NODE, which is parameter number 1 of function
// ISNODEISOLATED of core interface ISOLATESELECTION have param type is ParamType2::TYPE_INODE
// function ID of function SUPPRESSISOLATESELECTIONWARNINGDIALOGUE of core interface ISOLATESELECTION is 4
#define SUPPRESSISOLATESELECTIONWARNINGDIALOGUE_IISOLATESELECTION 4
  // Result Type of function SUPPRESSISOLATESELECTIONWARNINGDIALOGUE of core interface ISOLATESELECTION is ParamType2::TYPE_VOID
  #define SUPPRESSISOLATESELECTIONWARNINGDIALOGUE_IISOLATESELECTION_RESULTTYPE ParamType2::TYPE_VOID
  // number parameter of fucntion SUPPRESSISOLATESELECTIONWARNINGDIALOGUE of core interface ISOLATESELECTION is 1
  #define SUPPRESSISOLATESELECTIONWARNINGDIALOGUE_IISOLATESELECTION_NUMPARAMS 1
  #define BSUPPRESS_SUPPRESSISOLATESELECTIONWARNINGDIALOGUE_IISOLATESELECTION_PARAM1_TYPE ParamType::TYPE_BOOL
  // BSUPPRESS, which is parameter number 1 of function
// SUPPRESSISOLATESELECTIONWARNINGDIALOGUE of core interface ISOLATESELECTION have param type is ParamType::TYPE_BOOL
// ---------------------- List Properties of core interface ISOLATESELECTION ----------------------
#define IISOLATESELECTION_NUMPROPS 1
// function_id of for get property ZOOMEXTENTS of core interface ISOLATESELECTION is 5
#define ZOOMEXTENTS_IISOLATESELECTION_GETTER 5
// function_id of for set property ZOOMEXTENTS of core interface ISOLATESELECTION is 6
