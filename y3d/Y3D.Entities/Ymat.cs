...
namespace y3d.e {
    ...
    static YmatReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "YXRQQlIiUgoHWU1hdE1hcBIaCgVpbWFnZRgBIAEoCzILLnkzZC5ZSW1hZ2US",
            "DQoFc2NhbGUYAiABKAISDAoEbmFtZRgDIAEoCRIOCgZyZXNfaWQYBCABKAki",
            "gAMKCFlCYXNlTWFwEhwKBmFsYmVkbxgBIAEoCzIMLnkzZC5ZTWF0TWFwEhoK",
            "BGJ1bXAYAiABKAsyDC55M2QuWU1hdE1hcBIcCgZub3JtYWwYAyABKAsyDC55",
            "M2QuWU1hdE1hcBIYCgJhbxgEIAEoCzIMLnkzZC5ZTWF0TWFwEh4KCHNwZWN1",
            "bGFyGAUgASgLMgwueTNkLllNYXRNYXASIgoMZGlzcGxhY2VtZW50GAYgASgL",
            "MgwueTNkLllNYXRNYXASIwoNdHJhbnNjbHVjZW5jeRgHIAEoCzIMLnkzZC5Z",
            "TWF0TWFwEh8KCXJvdWdobmVzcxgIIAEoCzIMLnkzZC5ZTWF0TWFwEh4KCG9w",
            "YWN0aXR5GAkgASgLMgwueTNkLllNYXRNYXASGgoEZnVsbBgKIAEoCzIMLnkz",
            "ZC5ZTWF0TWFwEh4KCG5vcm1hbF9zGBQgAygLMgwueTNkLllNYXRNYXASHAoG",
            "ZnVsbF9zGBUgAygLMgwueTNkLllNYXRNYXAiyAEKDFlNYXRTdGFuZGFyZBIK",
            "CgJpZBgBIAEoDRIMCgRuYW1lGAIgASgJEh4KB2RpZmZ1c2UYAyABKAsyDS55",
            "M2QuWURpZmZ1c2USIAoIc3BlY3VsYXIYBCABKAsyDi55M2QuWVNwZWN1bGFy",
            "Eh4KB2FtYmllbnQYBSABKAsyDS55M2QuWUFtYmllbnQSIAoIZW1pc3NpdmUY",
            "BiABKAsyDi55M2QuWUVtaXNzaXZlEhoKA21hcBgHIAEoCzINLnkzZC5ZQmFz",
            "ZU1hcCJkCghZTWF0VnJheRIcCgRicmRmGAEgASgOMg4ueTNkLkJSREZfVHlw",
            "ZRIeCgdkaWZmdXNlGAIgASgLMg0ueTNkLllEaWZmdXNlEhoKA21hcBgDIAEo",
            "CzINLnkzZC5ZQmFzZU1hcCKkAQoEWU1hdBIKCgJpZBgBIAEoDRIMCgRuYW1l",
            "GAIgASgJEiUKCm1fc3RhbmRhcmQYAyABKAsyES55M2QuWU1hdFN0YW5kYXJk",
            "Eh0KBm1fdnJheRgEIAEoCzINLnkzZC5ZTWF0VnJheRIbCgVtX3BichgFIAEo",
            "CzIMLnkzZC5ZTWF0UEJSEh8KB21fbXVsdGkYBiABKAsyDi55M2QuWU11bHRp",
            "TWF0IlEKCVlNdWx0aU1hdBImCg9kZWZhdWx0X2RpZmZ1c2UYASABKAsyDS55",
            "M2QuWURpZmZ1c2USHAoJbWF0ZXJpYWxzGAIgAygLMgkueTNkLllNYXQqKwoJ",
            "QlJERl9UeXBlEgkKBVBIT05HEAASCQoFQkxJTk4QARIICgRXQVJEEAJCCKoC",
            "BXkzZC5lYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::y3d.e.BRDF_Type), }, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::y3d.e.YMatMap), global::y3d.e.YMatMap.Parser, new[]{ "Image", "Scale", "Name", "ResId" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::y3d.e.YBaseMap), global::y3d.e.YBaseMap.Parser, new[]{ "Albedo", "Bump", "Normal", "Ao", "Specular", "Displacement", "Transclucency", "Roughness", "Opactity", "Full", "NormalS", "FullS" }, null, null, null),
  ...
  public sealed partial class YBaseMap : pb::IMessage<YBaseMap> {
    ...
    public YBaseMap(YBaseMap other) : this() {
      ...
      Full = other.full_ != null ? other.Full.Clone() : null;
      normalS_ = other.normalS_.Clone();
      fullS_ = other.fullS_.Clone();
    }
    ...
    public const int TransclucencyFieldNumber = 7;
    ...
    private global::y3d.e.YMatMap full_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public global::y3d.e.YMatMap Full {
      get { return full_; }
      set {
        full_ = value;
      }
    ...
    /// <summary>Field number for the "normal_s" field.</summary>
    public const int NormalSFieldNumber = 20;
    private static readonly pb::FieldCodec<global::y3d.e.YMatMap> _repeated_normalS_codec
        = pb::FieldCodec.ForMessage(162, global::y3d.e.YMatMap.Parser);
    private readonly pbc::RepeatedField<global::y3d.e.YMatMap> normalS_ = new pbc::RepeatedField<global::y3d.e.YMatMap>();
    /// <summary>
    ///  if has many version for normal map
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::y3d.e.YMatMap> NormalS {
      get { return normalS_; }
    }

    /// <summary>Field number for the "full_s" field.</summary>
    public const int FullSFieldNumber = 21;
    private static readonly pb::FieldCodec<global::y3d.e.YMatMap> _repeated_fullS_codec
        = pb::FieldCodec.ForMessage(170, global::y3d.e.YMatMap.Parser);
    private readonly pbc::RepeatedField<global::y3d.e.YMatMap> fullS_ = new pbc::RepeatedField<global::y3d.e.YMatMap>();
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public pbc::RepeatedField<global::y3d.e.YMatMap> FullS {
      get { return fullS_; }
    }
    ...
    public bool Equals(YBaseMap other) {
      ...
      if(!fullS_.Equals(other.fullS_)) return false;
      return true;
    }
    ...
    public override int GetHashCode() {
      ...
      if (full_ != null) hash ^= Full.GetHashCode();
      hash ^= normalS_.GetHashCode();
      hash ^= fullS_.GetHashCode();
      return hash;
    }
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      fullS_.WriteTo(output, _repeated_fullS_codec);
    }
    ...
    public int CalculateSize() {
      ...
      if (transclucency_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(Transclucency);
      }
      if (roughness_ != null) {
      ...
      size += fullS_.CalculateSize(_repeated_fullS_codec);
      return size;
    }
    ...
    public void MergeFrom(YBaseMap other) {
      ...
      if (other.full_ != null) {
        if (full_ == null) {
          full_ = new global::y3d.e.YMatMap();
        }
        Full.MergeFrom(other.Full);
      }
      normalS_.Add(other.normalS_);
      fullS_.Add(other.fullS_);
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 170: {
            fullS_.AddEntriesFrom(input, _repeated_fullS_codec);
            break;
          }
        }
      }
