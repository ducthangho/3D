...
def getY3dObj():
	...
	if ob.type == 'MESH':
		...
		bpy.ops.export_scene.obj(filepath='D:\\y3d.obj', use_selection=True,global_scale =1, use_materials=False, use_vertex_groups=True, use_normals=False, axis_forward=fw, axis_up=up)
